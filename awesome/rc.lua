...
beautiful.init("/home/jonathan/.config/awesome/themes/custom/theme.lua")
...
utilitymenu = {
  { "Baobab" , "baobab" },
  { "Disk Check", "gksudo gsmartcontrol" },
  { "Eclipse", "eclipse" },
...
awful.rules.rules = {
    ...
    { rule = { class = "gimp" },
      properties = { floating = true } },
	{ rule = { class = "Conky" }, callback = function(c) c:tags({tags[1][1], tags[1][2], tags[1][3], tags[1][4], tags[1][5]}) end},
